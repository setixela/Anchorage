...
public extension Anchors {
   ...
   @discardableResult
   func fitToTopRight(_ toView: UIView, constHeight: CGFloat = 0,
                      offset: CGFloat = 0, sideOffset: CGFloat = 0) -> Anchors
   {
      var anchors = view.addAnchors
         .top(toView.topAnchor, offset)
   ...
   @discardableResult
   func fitToTopLeft(_ toView: UIView, constHeight: CGFloat = 0,
                     offset: CGFloat = 0, sideOffset: CGFloat = 0) -> Anchors
   {
      var anchors = view.addAnchors
         .top(toView.topAnchor, offset)
   ...
   @discardableResult
   func fitToBottomRight(_ toView: UIView, constHeight: CGFloat = 0,
                         offset: CGFloat = 0, sideOffset: CGFloat = 0) -> Anchors
   {
      var anchors = view.addAnchors
         .bottom(toView.bottomAnchor, -offset)
   ...
   @discardableResult
   func fitToBottomLeft(_ toView: UIView, constHeight: CGFloat = 0,
                        offset: CGFloat = 0, sideOffset: CGFloat = 0) -> Anchors
   {
      var anchors = view.addAnchors
         .bottom(toView.bottomAnchor, -offset)
